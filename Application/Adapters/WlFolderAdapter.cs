...
namespace WordLearning.Domain.Adapters
{
    ...
    /// Array adapter start.
    /// </summary>
    public class WlFolderAdapter : RecyclerAdapter<WlDirectory, WlFolderViewHolder>
    {
        ...
        public WlFolderAdapter(AppCompatActivity context, WlFolder folder) : base(context, Resource.Layout.row_Explorer, folder)
        {
