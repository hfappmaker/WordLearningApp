...
public class Start_MoveAdapter
	extends crc6450d3c363f7763d4f.RecyclerAdapter
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WordLearning.Adapter.Start_MoveAdapter, wordlearning", Start_MoveAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Start_MoveAdapter.class)
			mono.android.TypeManager.Activate ("WordLearning.Adapter.Start_MoveAdapter, wordlearning", "", this, new java.lang.Object[] {  });
	}
