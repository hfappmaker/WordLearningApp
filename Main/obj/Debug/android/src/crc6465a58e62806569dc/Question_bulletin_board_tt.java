...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WordLearning.Activities.Question_bulletin_board+tt, wordlearning", Question_bulletin_board_tt.class, __md_methods);
	}
	...
	public Question_bulletin_board_tt ()
	{
		...
		if (getClass () == Question_bulletin_board_tt.class)
			mono.android.TypeManager.Activate ("WordLearning.Activities.Question_bulletin_board+tt, wordlearning", "", this, new java.lang.Object[] {  });
	}
