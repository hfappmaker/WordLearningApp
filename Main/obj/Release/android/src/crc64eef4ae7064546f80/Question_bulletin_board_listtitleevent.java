...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WordLearning.Question_bulletin_board+listtitleevent, wordlearning", Question_bulletin_board_listtitleevent.class, __md_methods);
	}
	...
	public Question_bulletin_board_listtitleevent ()
	{
		...
		if (getClass () == Question_bulletin_board_listtitleevent.class)
			mono.android.TypeManager.Activate ("WordLearning.Question_bulletin_board+listtitleevent, wordlearning", "", this, new java.lang.Object[] {  });
	}

	public Question_bulletin_board_listtitleevent (crc64eef4ae7064546f80.Question_bulletin_board p0)
	{
		super ();
		if (getClass () == Question_bulletin_board_listtitleevent.class)
			mono.android.TypeManager.Activate ("WordLearning.Question_bulletin_board+listtitleevent, wordlearning", "WordLearning.Question_bulletin_board, wordlearning", this, new java.lang.Object[] { p0 });
	}
