...
public class ArrayAdapter_Start_Move
	extends crc64eef4ae7064546f80.RecyclerAdapter
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WordLearning.ArrayAdapter_Start_Move, wordlearning", ArrayAdapter_Start_Move.class, __md_methods);
	}


	public ArrayAdapter_Start_Move ()
	{
		super ();
		if (getClass () == ArrayAdapter_Start_Move.class)
			mono.android.TypeManager.Activate ("WordLearning.ArrayAdapter_Start_Move, wordlearning", "", this, new java.lang.Object[] {  });
	}
