...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WordLearning.Learn_Wordlist+GestureListener, wordlearning", Learn_Wordlist_GestureListener.class, __md_methods);
	}
	...
	public Learn_Wordlist_GestureListener ()
	{
		...
		if (getClass () == Learn_Wordlist_GestureListener.class)
			mono.android.TypeManager.Activate ("WordLearning.Learn_Wordlist+GestureListener, wordlearning", "", this, new java.lang.Object[] {  });
	}

	public Learn_Wordlist_GestureListener (crc64eef4ae7064546f80.Learn_Wordlist p0)
	{
		super ();
		if (getClass () == Learn_Wordlist_GestureListener.class)
			mono.android.TypeManager.Activate ("WordLearning.Learn_Wordlist+GestureListener, wordlearning", "WordLearning.Learn_Wordlist, wordlearning", this, new java.lang.Object[] { p0 });
	}
